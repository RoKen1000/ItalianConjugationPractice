    ...
    public class WordDatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PresentPerfect>().HasData(
                    ...
                    new PresentPerfect { Id = 4, Infinitive = "venire", FirstPersonSingular = "sono venuto", SecondPersonSingular = "sei venuto", ThirdPersonSingular = "è venuto", FirstPersonPlural = "siamo venuto", SecondPersonPlural = "siete venuto", ThirdPersonPlural = "sono venuto", UsesEssere = true, EnglishTranslation = "to come" },
